...
def run_greedy():
    ...
    lot_instance_file = f'simulation_state/lot_instance_{a.dataset}.txt'
    ...
    lot_instance_file = f'dispatching_output_{a.dataset}/dispatching_seed{a.seed}_{a.dispatcher}_{a.days}s.txt'
    with open(lot_instance_file, 'w') as file:
